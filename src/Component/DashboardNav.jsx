...
const DashboardNav = () => {
    ...
    return (
        ...
        <div className='h-full bg-[#0D8343] pl-8 w-[25vw]flex flex-col'>
            <div className='pt-6' >
                <img src={UserLogo} alt="Logo" />
            </div>
            <div className='flex flex-col pt-10'>
                <div className='flex flex-col gap-y-6'>
                    <Link to='/dashboard'><h2 className='flex items-center text-white text-[18px] font-semibold gap-x-1'><RiDashboardFill className='text-[#16DA70] text-[30px]' />Dashboard</h2></Link>

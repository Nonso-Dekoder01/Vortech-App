...
const CandidateManagementNav = () => {

    return (

        <div className='h-full bg-[#0D8343] pl-8 w-[25vw] fixed flex flex-col'>
            <div className='pt-6' >
            ...
            <div className='flex flex-col pt-10'>
                <div className='flex flex-col gap-y-6'>
                    ...
                    <Link to='/candidates'><h2 className='flex items-center text-white text-[18px] font-semibold gap-x-1'><FaVoteYea className='text-[#16DA70] text-[30px]' />Candidate Management</h2></Link>
...
export default CandidateManagementNav
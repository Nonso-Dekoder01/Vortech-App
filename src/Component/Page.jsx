              ...
              <div className='mt-2 space-y-2'>
                ...
                <div className='relative'>
                  <div
                    ...
                    className={`md:w-[900px] w-[350px] font-bold select-none text-green-800 bg-green-500 px-5 flex justify-between items-center h-12  transition-opacity transition-duration-300 ${isActive ? 'rounded-t-lg' : 'rounded-lg'
                      }`}
                  >
                  ...
                  {isActive && (
                    <div
                      className={`w-[350px] md:w-[900px] text-green-800 cursor-pointer transition-duration-2 bg-green-500 rounded-lg ${isActive ? 'h-[360px] opacity-100' : 'h-0 opacity-0'
                        }`}
                    >
                      {options.map((option) => (
                        <div

...
import { Comp } from '../assets/asset'
import { Link } from 'react-router-dom'

const Dashboard = () => {
    return (
        <div className="flex pb-8 w-screen">
            ...
            <div className='overflow-y-scroll h-screen  w-9/12'>
                <div className='w-full py-7 px-7 flex flex-col gap-9'>
                    <div className='flex flex-col gap-y-5'>
                        ...
                        <div className='w-full h-[260px] bg-[#0D8343] rounded-[4px] py-3 px-10 flex justify-between items-center'>
                            ...
                            <div>
                                <img src={Comp} alt="" className='w-[250px] h-[200px]' />
                            </div>
                        </div>

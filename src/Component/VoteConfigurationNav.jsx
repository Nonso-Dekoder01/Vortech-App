...
const VoteConfigurationNav =  () => {

    return (

        <div className='h-full bg-[#0D8343] w-[25vw] pl-8 flex flex-col'>
            <div className='pt-6' >
            ...
            <div className='flex flex-col pt-10'>
                <div className='flex flex-col gap-y-6'>
                    ...
                    <Link to='/votemanagement'><h2 className='flex items-center text-zinc-400 text-[18px] font-semibold gap-x-1'><LiaUserCheckSolid className='text-[#16DA70] text-[30px]' />Voter Management</h2></Link>
                    ...
                    <Link to='/voteconfiguration'><h2 className='flex items-center text-white text-[18px] font-semibold gap-x-1'><TbFileSettings className='text-[#16DA70] text-[30px]' />Vote configuration</h2></Link>
...
export default VoteConfigurationNav